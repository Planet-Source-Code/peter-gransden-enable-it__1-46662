...
'/******************************************************************************
'Description: Finds the top level perent(if any)
'
'Inputs: Windows Handle
'
'Returns: Highest-level parent window of hWnd,if hWnd is the parent
'it just returns the input hWnd
'/******************************************************************************
Dim ParentHwnd As Long ' Holds the Parents Hwnd
Dim tmpHwnd As Long ' Holds a temp Hwnd
